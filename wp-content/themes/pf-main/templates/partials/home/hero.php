<div class="hero hero--full flex-row align-middle">
    <div class="hero__content width-100">
        <div class="grid-container margin-top-1">
            <p class="h1 type-it text-lowercase">Public Function<br>{</p>
            <div class="margin-left-2">
                <div class="grid-x grid-margin-x align-middle">
                    ...
                    <div class="cell large-6 show-for-large text-center">
                        <span class="fa fa-laptop-code hero__icon type-it type-it--after type-it--fade-up img-move" data-type-it-delay="1500" aria-label="image of laptop" data-move="7"></span>
                    </div>
                </div>
            </div>
